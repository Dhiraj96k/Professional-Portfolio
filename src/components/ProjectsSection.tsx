...
const projects = [
  {
    ...
    size: "large",
    github: "https://github.com/Dhiraj96k"
  },
  {
...
const ProjectsSection = () => (
  <section id="projects" className="section-projects py-24 relative overflow-hidden">
    {/* Decorative blur */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 auto-rows-[250px]">
        {projects.map((p, i) => (
          <motion.div
            ...
            className={`group relative overflow-hidden rounded-[2.5rem] border border-white/10 glass-card transition-all duration-500 hover:border-accent/30 ${
          ...
          >
            ...
            <div className="relative z-10 h-full p-8 md:p-12 flex flex-col justify-end">
              ...
              <div className="flex gap-4 mt-8 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                <a href={p.github} target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-accent text-accent-foreground hover:scale-110 transition-transform">
